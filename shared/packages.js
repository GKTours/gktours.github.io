...
window.THEMES = ["Car fare", "Day trip", "Pilgrimage", "Nature"];
...
window.PACKAGES = [
  {
    ...
    region: "rayalaseema",
    tags: ["Pilgrimage"],
    days: 2, nights: 1, price: 2500,
    // Priced per vehicle, whole car. `price` above is the cheapest of
    // these and is what the corner stamp shows as "from".
    vehiclePrices: { sedan: 2500, suv: 3300 },
    scene: "temple", mood: "dawn",
    photo: "images/tirumala.jpg",
  ...
  // ---- one-day temple trips from Tirupati (nights: 0 shows as "Day trip") ----
  {
    ...
    photo: "images/tirupati-local.jpg",
